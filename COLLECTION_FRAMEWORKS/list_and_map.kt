...
// tyre are two types of list mutable and immutable list
...
//immutable list is covariant in nature
// fun main() {
...
// mutable list is covariant in nature
// fun main(){
...
// map
// map is type of collection that holds key value pair
// map is created using mapOf() function
// map is covariant in nature
...
// it contains lots of function like filter, map, etc so prefer to see it official documentation link is given below
