...
// In this example, "Alice" and 30 are the arguments passed to the greet function. These arguments are used to fulfill the parameters defined in the function's signature. The function will process these arguments within its execution to produce the desired output.


// 8 first-class citizens  --> first-class citizens in programming languages are entities that can be manipulated in the same way as other entities such as integers, strings, and booleans. In Kotlin, functions are first-class citizens, which means they can be passed as arguments to other functions, returned from other functions, and assigned to variables.
